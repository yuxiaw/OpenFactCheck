...
from factscore.clm import CLM, LLaMA3
...
class FactScorer(object):
    ...
    def __init__(self,
        ...
        if "llama" in model_name:
            ...
            self.lm = LLaMA3("meta-llama/Meta-Llama-3-8B-Instruct",
                             cache_file=os.path.join(cache_dir, "inst-llama3-8B.pkl"),
    ...
    def get_score(self,
        ...
        # register db from a db file or jsonl. jsonl requires building up db.
        # set up db, retrieval, and npm if applicable
        if knowledge_source not in self.retrieval:
            self.register_knowledge_source(knowledge_source)

        # there are something wrong with the following condition, should remove len(generations)
        ...
        if atomic_facts is not None:
            ...
            # original atomatic fact generator is davinci-003, change to gpt-3.5-turbo.
            # should be an arguments
